...
@AgentInfo(hasGoals={
        ...
        "io.github.agentsoz.ees.agents.Mallorca.GoalGotoEvacPlace",
        "io.github.agentsoz.ees.agents.Mallorca.GoalGotoInvacPlace"


})
public class PreparedProtector extends ArchetypeAgent {

    private Prefix prefix = new PreparedProtector.Prefix();

    public PreparedProtector(String id) {
        super(id);
    }

    class Prefix {
        public String toString() {
            return String.format("%05.0f|%s|%s|%s|", getTime(), getTimeString(), VigilantProtector.class.getSimpleName(), getId());
        }
    }
