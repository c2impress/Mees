...
@AgentInfo(hasGoals={
        ...
        "io.github.agentsoz.ees.agents.Mallorca.GoalDoNothing"

})
public class Passiveobserver extends ArchetypeAgent {

    private Prefix prefix = new Passiveobserver.Prefix();

    public Passiveobserver(String id) {
        super(id);
    }

    class Prefix {
        public String toString() {
            return String.format("%05.0f|%s|%s|%s|", getTime(), getTimeString(), DelayedResponder.class.getSimpleName(), getId());
        }
    }
