...
@AgentInfo(hasGoals={
        ...
        "io.github.agentsoz.ees.agents.Mallorca.GoalGotoDependents",
        "io.github.agentsoz.ees.agents.Mallorca.GoalGotoInvacPlace",
        "io.github.agentsoz.ees.agents.Mallorca.GoalGotoEvacPlace"


})
public class ResponsiveInformationSeeker extends ArchetypeAgent {

    private Prefix prefix = new ResponsiveInformationSeeker.Prefix();

    public ResponsiveInformationSeeker(String id) {
        super(id);
    }
